...
?>
    <div class="beeteam368-top-menu beeteam368-top-menu-control">
        <div class="<?php echo esc_attr(beeteam368_container_classes_control('h-marguerite')); ?>">
            <div class="site__row flex-row-control flex-vertical-middle beeteam368-top-menu-row">
                ...
                <div class="site__col auto-width beeteam368-top-middle-posts">
                    <?php do_action('beeteam368_top_middle_posts', $beeteam368_header_style); ?>
                </div>
        ...
        <div class="<?php echo esc_attr(beeteam368_container_classes_control('h-marguerite')); ?>">
            <div class="site__row flex-row-control flex-vertical-middle beeteam368-middle-menu-row">
                ...
                <div class="site__col auto-width beeteam368-top-middle-content">
                    <?php do_action('beeteam368_top_middle_content', $beeteam368_header_style); ?>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="beeteam368-main-menu beeteam368-main-menu-control">
        <div class="<?php echo esc_attr(beeteam368_container_classes_control('h-marguerite')); ?> beeteam368-menu-container-mobile">
            <div class="site__row flex-row-control flex-vertical-middle beeteam368-main-menu-row">
                ...
                <div class="site__col beeteam368-searchbox">
                    <?php do_action('beeteam368_searchbox', 'navigation', $beeteam368_header_style, ''); ?>
                </div>
