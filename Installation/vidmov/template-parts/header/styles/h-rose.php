...
?>
    <div class="beeteam368-top-menu beeteam368-top-menu-control">
        <div class="<?php echo esc_attr(beeteam368_container_classes_control('h-rose')); ?>">
    ...
    <div class="beeteam368-main-menu beeteam368-main-menu-control">
        <div class="<?php echo esc_attr(beeteam368_container_classes_control('h-rose')); ?> beeteam368-menu-container-mobile">
